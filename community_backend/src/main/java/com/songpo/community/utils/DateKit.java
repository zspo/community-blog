...
public class DateKit {
    ...
    public static long getUnixTimeByString(String c_time) {
        try {
            Date date = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(c_time);
